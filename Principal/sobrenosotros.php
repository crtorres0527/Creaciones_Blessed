  ...
  <body>
    ...
    <div class="page"><a class="section section-banner d-none d-xl-flex"> 
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="sobrenosotros.php">Sobre nosotros</a>
                      </li>
                    ...
                    </ul><a class="button button-white button-sm" href="#">Iniciar sesion</a>
                  </div>
                </div><a class="button button-white button-sm" href="#">Iniciar sesion</a>
              </div>
            </div>
          </nav>
        </div>
      ...
      <section class="section section-lg bg-gray-1">
        <div class="container">
          <div class="row row-50">
            <div class="col-lg-6 pr-xl-5"><img src="images/sobre.nosotros.jpg" alt="" width="518" height="434"/>
            </div>
            <div class="col-lg-6">
              <h2>Nuestra tienda</h2>
              <div class="text-with-divider">
                <div class="divider"></div>
                <h4>Ofrecemos variedad de regalos para diferentes dias especiales</h4>
              </div>
      ...
      <section class="section section-lg bg-white">
        <div class="container">
          <h2 class="text-center">Por qué nos eligen</h2>
          <div class="row row-30 row-md-60">
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                <div class="box-icon-inner"><img class="icon-xl" src="images/icons8-person.gif" restaurant-icon-30"></span></div>
                <div class="box-icon-caption">
                  <h4><a href="#">Equipo amistoso</a></h4>
            ...
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                <div class="box-icon-inner"><img class="icon-xl" src="images/icons8-bolsa-de-compras.gif"></span></div>
                <div class="box-icon-caption">
                  <h4><a href="#">Productos frescos</a></h4>
            ...
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                <div class="box-icon-inner"><img class="icon-xl" src="images/icons8-aprobación.gif"></span></div>
                <div class="box-icon-caption">
                  <h4><a href="#">Regalos de calidad</a></h4>
            ...
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                <div class="box-icon-inner"><img class="icon-xl" src="images/icons8-entrega.gif"></span></div>
                <div class="box-icon-caption">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                <div class="box-icon-inner"><img class="icon-xl" src="images/icons8-confianza.gif"></span></div>
                <div class="box-icon-caption">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                <div class="box-icon-inner"><img class="icon-xl" src="images/icons8-futuros.gif"></span></div>
                <div class="box-icon-caption">
                  <h4><a href="#">Precio asequibles</a></h4>
            ...
            <div class="slick-slider carousel-parent slick-style-1" data-arrows="true" data-loop="false" data-dots="false" data-swipe="true" data-items="1" data-child="#child-carousel" data-for="#child-carousel">
              <div class="item">
                <div class="testimonials-modern">
                  ...
                  <div class="testimonials-modern-name">Jhoan Duarte</div>
                </div>
              </div>
              <div class="item">
                <div class="testimonials-modern">
              ...
              <div class="item">
                <div class="slick-dot-item"><img src="images/user.jpeg" alt="" width="60" height="60"/>
                </div>
              </div>
            </div>
          </div>
