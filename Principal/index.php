    ...
    <div class="page"><a class="section section-banner d-none d-xl-flex"></a>
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="catalogo.php">Catalogo</a>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="contacts.php">Contactenos</a>
                      </li>
                    </ul><a class="button button-white button-sm" href="../Vista/login.php">Iniciar sesion</a>
                  </div>
                </div><a class="button button-white button-sm" href="../Vista/login.php">Iniciar sesion</a>
              </div>
            </div>
          </nav>
        </div>
        ...
        <div class="main-bunner-inner">
          <div class="container">
            <div class="box-default">
              ...
              <p class="big box-default-text"> e-commerce Creaciones blessed </p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="container">
            <div class="row row-50 justify-content-xl-between align-items-lg-center">
              ...
              <div class="col-lg-6 col-xl-5 wow fadeInRight">
                ...
                <p> e-commerce Creaciones blessed se puede utilizar para referirse a ese universo de tiendas online creadas por todo tipo de emprendedores, desde artesanos independientes hasta grandes empresas. En cuanto al uso del término en el día a día, se refiere al intercambio de bienes o servicios a través de internet.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="row justify-content-center text-center">
            <div class="col-md-9 col-lg-7 wow-outer">
              <div class="wow slideInDown">
                ...
                <p class="text-opacity-80">Ofrecemos una gran variedad de regalos unicos  a nuestros visitantes. A continuación se presentan algunos de nuestros regalos principales y populares</p>
              </div>
            </div>
          </div>
      ...
      <section class="section-lg bg-default">
        <div class="container wow-outer">
          <h2 class="text-center wow slideInDown">Eventos recientes</h2>
          <!-- Owl Carousel-->
          <div class="owl-carousel wow fadeInUp" data-items="1" data-md-items="2" data-lg-items="3" data-dots="true" data-nav="false" data-stage-padding="15" data-loop="false" data-margin="30" data-mouse-drag="false">
            <div class="post-corporate"><a class="badge" href="#">feb 02, 2021</a>
            ...
            <div class="post-corporate"><a class="badge" href="#">mar 12, 2021</a>
            ...
            <div class="post-corporate"><a class="badge" href="#"> agu 02, 2021</a>
            ...
            <div class="post-corporate"><a class="badge" href="#">Aug 15, 2021</a>
            ...
            <div class="post-corporate"><a class="badge" href="#">Sep 15, 2021</a>
            ...
            <div class="post-corporate"><a class="badge" href="#">Sep 28, 2021</a>
            ...
            <div class="post-corporate"><a class="badge" href="#">Oct 05, 2021</a>
            ...
            <div class="post-corporate"><a class="badge" href="#">Oct 17, 2021</a>
            ...
            <div class="post-corporate"><a class="badge" href="#">Nov 10, 2021</a>
      ...
      <footer class="section footer-minimal context-dark">
        <div class="container wow-outer">
          <div class="wow fadeIn">
            ...
            <p class="rights"><span>&copy;&nbsp; </span><span class="copyright-year"></span><span>&nbsp;</span><span>Blessed</span><span>.&nbsp;</span><span>All Rights Reserved.</span><span>&nbsp;</span><a href="#">Privacy Policy</a>. Design&nbsp;by&nbsp;CreacionesBlessed</p>
          </div>
        </div>
      </footer>
    </div>
